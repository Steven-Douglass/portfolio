    ...
    return (
      <div id="calculator">
        ...
        <div id="buttons">
          ...
          <button onClick={() => this.handleClickNum("0")} id="btn0">
            0
          </button>
          <button
          ...
          <button onClick={() => this.handleClickOperator("AC")} id="AC">
            AC
          </button>
          <button onClick={() => this.handleClickOperator("CE")} id="CE">
            CE
          </button>
          <button
            onClick={() => this.handleClickOperator("+-")}
